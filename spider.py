...
headers = {
    ...
    'Cookie': 'user_trace_token=20170603115043-d0c257a054ee44f99177a3540d44dda1; '
              'LGUID=20170603115044-d1e2b4d1-480f-11e7-96cf-525400f775ce; '
              'JSESSIONID=ABAAABAAAGHAABHAA8050BE2E1D33E6C2A80E370FE9167B; _gat=1; PRE_UTM=; PRE_HOST=; PRE_SITE=; '
              'PRE_LAND=https%3A%2F%2Fwww.lagou.com%2F; index_location_city=%E5%85%A8%E5%9B%BD; login=false; '
              'unick=""; _putrc=""; _ga=GA1.2.922290439.1496461627; X_HTTP_TOKEN=3876430f68ebc0ae0b8fac6c9f163d45; '
              '_ga=GA1.3.922290439.1496461627; LGSID=20170720174323-df1d6e50-6d2f-11e7-ac93-5254005c3644; '
              'LGRID=20170720174450-12fc5214-6d30-11e7-b32f-525400f775ce; '
              'Hm_lvt_4233e74dff0ae5bd0a3d81c6ccf756e6=1500541369; '
...
def parse_link(url, MONGO_TABLE):
    for page in range(1, 31):
        ...
        if r.status_code == 404:
            ...
            # 公司福利
            fulis = soup.select('ul > li > div.list_item_bot > div.li_b_l')

            for position, add, publish, money, need, company, tag, fuli in zip(positions, adds, publishs, moneys, needs,
                                                                               companys, tags, fulis):
                data = {
